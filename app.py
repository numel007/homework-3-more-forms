...
def animal_facts():
    ...
    animal_picked = request.args.get("animal")
...
def save_image(image, filter_type):
    ...
    # Construct full file path - I changed file_name to new_file_name <---------------
...
def gif_search():
    ...
    if request.method == 'POST':
        ...
        # variable
        search_terms = request.form.get("search_query")
